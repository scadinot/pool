...
image::../images/config_filtration_hchp.png["Onglet Filtration",align="Center"]
...
__Il n'y a pas de réglage de fin des heures creuses de nuit. Le plugin considère que le total des heures creuses n'excède pas 8 heures par jour.__
